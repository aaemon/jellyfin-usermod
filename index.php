...
// Check if this is a request to update user policies
$requestUri = $_SERVER['REQUEST_URI'] ?? '';
if (strpos($requestUri, 'update-policies') !== false || 
    (isset($_GET['action']) && $_GET['action'] === 'update-policies')) {
...
try {
    ...
    echo json_encode([
        ...
        'count' => count($users),
        'timestamp' => date('Y-m-d H:i:s'),
        'note' => 'Add ?action=update-policies to the URL to update user permissions'
    ], JSON_PRETTY_PRINT);
